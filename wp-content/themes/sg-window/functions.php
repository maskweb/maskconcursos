...
?>
	...
	<div class="sg-site-header-1">
		...
		<div class="site-title">
			<div class="page-name"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></div>
		</div><!-- .site-title -->
		<!-- Dscription -->
		<div class="site-description">
			<div class="page-descript""><?php echo bloginfo( 'description' ); ?></div>
			...
			<?php if ( '1' == sgwindow_get_theme_mod( 'is_show_secont_top_menu') ) : ?>
				...
				<div class="nav-container top-navigation">
					...
					<nav class="horisontal-navigation menu-2" role="navigation">
						...
						<?php getSubCategories(get_query_var('cat')); ?>
...
/* personalización maskconcursos *//* no muestro el apartado "Related Posts" *//*
	if ( is_single() ) {
	...
	the_widget( 'sgwindow_items_category', 'title='.__('Novedades masKconcursos', 'sg-window').
								'&count=6'.
								'&category=0'.
								'&columns=column-1'.
								'&is_background=1'.
