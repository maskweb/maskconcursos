...
function getSubCategories($categoryId){
	...
	if(!empty($categoryId)){
		...
		if(!empty($subCatIds)){
			echo '<div class="menu-sub-container">';
			echo '<ul class="nav-horizontal" id="menu-sub">';

			foreach($subCatIds as $sub){
				$objSubCategory = get_category( $sub );

				echo '<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-'.$sub.'" id="menu-item-'.$sub.'" style="">';
				echo '<a href="'.$baseUrl.$objCategory->slug.'/'.$objSubCategory->slug.'/">'.$objSubCategory->name.'</a>';
				echo '</li>';
			}
		}
